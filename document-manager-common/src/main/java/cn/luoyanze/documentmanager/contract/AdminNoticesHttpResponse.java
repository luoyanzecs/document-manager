...
public class AdminNoticesHttpResponse {
    ...
    public AdminNoticesHttpResponse(Head head, List<String> fields, List<String> keys, List<Integer> cols, Integer currentPage, Integer totalPage, List<NoticeInAdmin> notices) {
        this.head = head;
        this.fields = fields;
        this.keys = keys;
        this.cols = cols;
