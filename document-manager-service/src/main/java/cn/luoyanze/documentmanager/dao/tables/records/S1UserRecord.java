...
public class S1UserRecord extends UpdatableRecordImpl<S1UserRecord> implements Record12<UInteger, String, String, String, String, String, String, LocalDateTime, LocalDateTime, Integer, String, Integer> {
     ...
     */
    public S1UserRecord(UInteger primaryId, String uuid, String account, String password, String role, String tel, String email, LocalDateTime lastLoginTime, LocalDateTime registerTime, Integer status, String bu, Integer authority) {
        super(S1UserTB.S1_USER);
