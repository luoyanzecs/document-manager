...
public class S1CommentRecord extends UpdatableRecordImpl<S1CommentRecord> implements Record6<UInteger, String, UInteger, String, LocalDateTime, UInteger> {
    ...
    @Override
    public Row6<UInteger, String, UInteger, String, LocalDateTime, UInteger> valuesRow() {
    ...
    @Override
    public S1CommentRecord values(UInteger value1, String value2, UInteger value3, String value4, LocalDateTime value5, UInteger value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public S1CommentRecord(UInteger primaryId, String uuid, UInteger docId, String ctx, LocalDateTime createTime, UInteger parentId) {
        super(S1CommentTB.S1_COMMENT);
