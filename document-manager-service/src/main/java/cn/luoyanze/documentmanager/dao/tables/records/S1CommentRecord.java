...
public class S1CommentRecord extends UpdatableRecordImpl<S1CommentRecord> implements Record6<Integer, Integer, Integer, String, LocalDateTime, Integer> {
    ...
    @Override
    public S1CommentRecord values(Integer value1, Integer value2, Integer value3, String value4, LocalDateTime value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public S1CommentRecord(Integer primaryId, Integer docId, Integer userId, String ctx, LocalDateTime createTime, Integer parentId) {
        super(S1CommentTB.S1_COMMENT);
