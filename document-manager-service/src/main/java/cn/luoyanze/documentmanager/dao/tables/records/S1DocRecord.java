...
public class S1DocRecord extends UpdatableRecordImpl<S1DocRecord> implements Record9<UInteger, String, String, Integer, Integer, String, UInteger, LocalDateTime, UInteger> {
    ...
    @Override
    public Row9<UInteger, String, String, Integer, Integer, String, UInteger, LocalDateTime, UInteger> valuesRow() {
    ...
    @Override
    public S1DocRecord values(UInteger value1, String value2, String value3, Integer value4, Integer value5, String value6, UInteger value7, LocalDateTime value8, UInteger value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public S1DocRecord(UInteger primaryId, String uuid, String permissionBu, Integer authority, Integer status, String ctx, UInteger userId, LocalDateTime lastUpdateTime, UInteger lastUpdateUserId) {
        super(S1DocTB.S1_DOC);
