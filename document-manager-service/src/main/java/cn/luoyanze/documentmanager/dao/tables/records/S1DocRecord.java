...
public class S1DocRecord extends UpdatableRecordImpl<S1DocRecord> implements Record11<Integer, String, Integer, Integer, String, Integer, LocalDateTime, String, Integer, Integer, Integer> {
    ...
    @Override
    public Row11<Integer, String, Integer, Integer, String, Integer, LocalDateTime, String, Integer, Integer, Integer> valuesRow() {
    ...
    @Override
    public S1DocRecord value6(Integer value) {
        setUserId(value);
        return this;
    }
    ...
    @Override
    public S1DocRecord value11(Integer value) {
        setIsdel(value);
        return this;
    }

    @Override
    public S1DocRecord values(Integer value1, String value2, Integer value3, Integer value4, String value5, Integer value6, LocalDateTime value7, String value8, Integer value9, Integer value10, Integer value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public S1DocRecord(Integer primaryId, String permissionBu, Integer authority, Integer status, String ctx, Integer userId, LocalDateTime lastUpdateTime, String title, Integer dirId, Integer lastUpdateUserId, Integer isdel) {
        super(S1DocTB.S1_DOC);
