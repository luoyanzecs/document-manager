...
public class S1AttachRecord extends UpdatableRecordImpl<S1AttachRecord> implements Record8<Integer, Integer, String, String, Integer, LocalDateTime, Integer, Integer> {
    ...
    @Override
    public Row8<Integer, Integer, String, String, Integer, LocalDateTime, Integer, Integer> valuesRow() {
    ...
    @Override
    public S1AttachRecord value5(Integer value) {
        setSize(value);
        return this;
    }
    ...
    @Override
    public S1AttachRecord values(Integer value1, Integer value2, String value3, String value4, Integer value5, LocalDateTime value6, Integer value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public S1AttachRecord(Integer primaryId, Integer docPrimaryId, String link, String name, Integer size, LocalDateTime time, Integer userPrimaryId, Integer isdel) {
        super(S1AttachTB.S1_ATTACH);
