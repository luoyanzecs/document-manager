...
public class S1OperateRecord extends UpdatableRecordImpl<S1OperateRecord> implements Record7<Integer, Integer, LocalDateTime, Integer, Integer, String, Integer> {
    ...
    @Override
    public Row7<Integer, Integer, LocalDateTime, Integer, Integer, String, Integer> valuesRow() {
    ...
    public Field<Integer> field7() {
        return S1OperateTB.S1_OPERATE.ISDEL;
    }
    ...
    @Override
    public S1OperateRecord value7(Integer value) {
        setIsdel(value);
        return this;
    }

    @Override
    public S1OperateRecord values(Integer value1, Integer value2, LocalDateTime value3, Integer value4, Integer value5, String value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public S1OperateRecord(Integer primaryId, Integer type, LocalDateTime time, Integer docId, Integer userId, String content, Integer isdel) {
        super(S1OperateTB.S1_OPERATE);
