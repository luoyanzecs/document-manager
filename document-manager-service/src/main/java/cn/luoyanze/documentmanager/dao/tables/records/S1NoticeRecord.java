...
public class S1NoticeRecord extends UpdatableRecordImpl<S1NoticeRecord> implements Record8<UInteger, Integer, String, LocalDateTime, LocalDateTime, String, String, Integer> {
    ...
    @Override
    public Row8<UInteger, Integer, String, LocalDateTime, LocalDateTime, String, String, Integer> valuesRow() {
    ...
    @Override
    public S1NoticeRecord values(UInteger value1, Integer value2, String value3, LocalDateTime value4, LocalDateTime value5, String value6, String value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public S1NoticeRecord(UInteger primaryId, Integer type, String content, LocalDateTime startTime, LocalDateTime endTime, String acceptUsers, String acceptBu, Integer isGlobal) {
        super(S1NoticeTB.S1_NOTICE);
