...
public class S1NoticeRecord extends UpdatableRecordImpl<S1NoticeRecord> implements Record9<Integer, Integer, String, LocalDateTime, LocalDateTime, String, String, Integer, Integer> {
    ...
    @Override
    public Row9<Integer, Integer, String, LocalDateTime, LocalDateTime, String, String, Integer, Integer> valuesRow() {
    ...
    @Override
    public S1NoticeRecord values(Integer value1, Integer value2, String value3, LocalDateTime value4, LocalDateTime value5, String value6, String value7, Integer value8, Integer value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public S1NoticeRecord(Integer primaryId, Integer type, String content, LocalDateTime startTime, LocalDateTime endTime, String acceptUsers, String acceptBu, Integer isGlobal, Integer isdel) {
        super(S1NoticeTB.S1_NOTICE);
